  ...
  return (
    ...
    >
      <div className="sticky top-0 h-screen flex items-center overflow-hidden">
        <div className="container-forge relative z-[var(--z-content)] w-full pt-[var(--nav-height)]">
          ...
          <div
            ref={enterForgeRef}
            className="pointer-events-none absolute bottom-[18%] left-0 opacity-0 will-change-transform"
            aria-hidden="true"
          >
          ...
          <p
            ref={editorialRef}
            className="pointer-events-none absolute top-[42%] left-0 opacity-0 will-change-transform type-micro tracking-[0.35em] text-[var(--muted)] uppercase"
            aria-hidden="true"
          >
            {BRAND.values[2]}
          </p>
        ...
        <div
          ref={scrollHintRef}
          className="absolute bottom-10 left-1/2 -translate-x-1/2 z-[var(--z-content)] flex flex-col items-center gap-3"
          aria-hidden="true"
        >
